      ...
      <div className="lg:sticky lg:top-20">
        <nav className="flex items-center justify-between relative pb-1 fade md:overflow-auto md:relative" id="nav">
          ...
          {mounted && (
            <button 
              onClick={toggleTheme} 
              className="flex transition-all duration-1500 ease-in-out hover:text-neutral-800 dark:hover:text-neutral-200"
            >
              <img
              ...
              <img
                ...
                className={`h-12 w-12 transition-opacity duration-1500 ease-in-out ${theme === 'dark' ? 'opacity-100' : 'opacity-100'}`}
              />
            </button>
          )}
        </nav>
